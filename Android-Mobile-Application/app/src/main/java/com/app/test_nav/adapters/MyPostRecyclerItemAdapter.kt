...
class MyPostRecyclerItemAdapter(private val posts: ArrayList<PostInfo>) : RecyclerView.Adapter<MyPostRecyclerItemAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.setOnClickListener {
                ...
                Toast.makeText(itemView.context, "Swipe left to delete and swipe right to edit post", Toast.LENGTH_SHORT).show()
            }
        }
    }
